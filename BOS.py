...
def Select_Ontologies(Path_to_Data,Ontologies,Synonyms,MultipleOntologies,MakePlots,Comb,API_KEY,Single_Report_Path,Multiple_Report_Path,Mode,Ontologies_to_Select):
    ...
    try:
        ...
        print('Something is wrong with the file or the file path:\n')
        print(str(Exception))
    ...
    Report_Path = Single_Report_Path + "\\Annotation Report.csv"
...
if __name__ == '__main__':
    ...
    Mode = Settings['test all ontologies']#True if using all Bioportal ontologies, false is specific ontologies
    Ontologies = Settings['ontologies']#Select specific ontologies to annotate data (optional)  
    API_KEY = Settings['apikey']#Bioportal user api key
    Synonyms=Settings['synonyms']#Allow annotations from synonyms
    MultipleOntologies = Settings['test multiple ontologies']#True if selecting multiple ontologies at once 
    Comb = Settings['combinations']#Combination of how many ontologies 
    Ontologies_to_Select = Settings["ontologies to select"]#How many top performing ontologies are selected for multiple ontology evaluation
    Single_Report_Path = Settings['single report path']#Path to save annotation report and single ontology annotation performance barplot
    Multiple_Report_Path = Settings["multiple report path"]#Path to save multiple ontology report and performance barplots 
